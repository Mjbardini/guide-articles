...
HTML5 is the latest version, or specification, of HTML. The main difference between HTML and HTML5 can be that neither audio nor video is a constituent of HTML whereas both can be considered integral parts of HTML5. The World Wide Web Consortium (W3C) is the organization responsible for developing standards for the World Wide Web, including those for HTML. As web pages and web applications grow more complex, W3C runs the process to update HTML's standards.
